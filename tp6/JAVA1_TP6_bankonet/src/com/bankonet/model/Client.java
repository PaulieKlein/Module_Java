	...
	public String toString(){
		...
		if (compteCourant != null && compteEpargne != null){
			...
			return "Nom : "+ this.getNom() + "-\n" +
					   "Prénom : "+ this.getPrenom() + compteCourant.toString() + compteEpargne.toString() + "\n "; 
					}
			
			if (compteCourant == null && compteEpargne != null){
				 
				return "Nom : "+ this.getNom() + "-\n" +
						   "Prénom : "+ this.getPrenom() + compteEpargne.toString() + "\n Vous n'avez pas de compte courant"; 
				}
			
			if (compteCourant != null && compteEpargne == null){
				 
				return "Nom : "+ this.getNom() + "-\n" +
						   "Prénom : "+ this.getPrenom() + compteCourant.toString()  + "\n Vous n'avez pas de compte épargne"; 
				}
